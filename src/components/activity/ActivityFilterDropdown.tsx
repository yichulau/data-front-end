  ...
  return (
    <>
        <div ref={menuRef}>
            ...
            id="filterDropdownButton" data-dropdown-toggle="filterDropdown" className="w-full md:w-auto flex items-center justify-center py-2 px-2 text-xs font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-stone-200 dark:focus:ring-stone-700 dark:bg-stone-900 dark:text-gray-400 dark:border-gray-800 dark:hover:text-white dark:hover:bg-gray-700" type="button">
            ...
            <AnimatePresence>
            {
                isOpen && (
                    ...
                    <motion.div 
                        ...
                        id="filterDropdown" 
                        className="block z-10 p-3 bg-white right-2 divide-gray-100 rounded-lg shadow w-44 dark:bg-black absolute max-h-60 overflow-y-auto top-15 scrollbar-thumb-zinc-200 dark:scrollbar-thumb-zinc-800 scrollbar-track-white dark:scrollbar-track-zinc-600">
