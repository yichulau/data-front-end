        ...
        <div ref={menuRef}>
            ...
            </button>
            {
                isOpen && (
                    ...
                    <div id="filterDropdown" className="block z-10 p-3 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute max-h-60 overflow-y-auto top-1">
