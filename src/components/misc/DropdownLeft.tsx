    ...
    return (
        <>
            ...
            <div ref={menuRef}>
                ...
                {isOpen && (
                    <div id="dropdownDelay" className={ `left-[200px] md:left-auto block z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute max-h-48 overflow-y-auto`}>
