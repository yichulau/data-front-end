        ...
        <div ref={menuRef}>
            ...
            {isOpen && (
                    <div id="dropdownDelay" 
                        className={  `block z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-auto md:w-[28rem] dark:bg-gray-700 absolute h-full max-h-[28rem]`}>
                            {filteredOptions.length > 0 ? (
                                ...
                                {currency === null || exchanges === null ? (
                                    <>
                                    <div className="flex items-center text-center justify-center w-auto h-56 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                        <div className=' px-8'>
